...
#import <OpenCloudApp/OpenCloudApp.h>
...
- (void)testUnlock
{
	...
	OCLicenseManager *manager = [OCLicenseManager new];
	OCLicenseEnvironment *environment = [OCLicenseEnvironment environmentWithIdentifier:@"environment" hostname:@"demo.opencloud.eu" certificate:nil attributes:nil];
	TestProvider *provider = [TestProvider new];
...
- (void)testUnlockWithLimitedApplicability
{
	...
	OCLicenseManager *manager = [OCLicenseManager new];
	OCLicenseEnvironment *orgEnvironment = [OCLicenseEnvironment environmentWithIdentifier:@"org" hostname:@"demo.opencloud.eu" certificate:nil attributes:nil];
	OCLicenseEnvironment *comEnvironment = [OCLicenseEnvironment environmentWithIdentifier:@"com" hostname:@"demo.opencloud.eu" certificate:nil attributes:nil];
	TestProvider *provider = [TestProvider new];
