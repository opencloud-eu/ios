...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
		...
		Log.log("OpenCloud \(VendorServices.shared.appVersion) (\(VendorServices.shared.appBuildNumber)) #\(GitInfo.app.versionInfo) finished launching with log settings: \(Log.logOptionStatus)")
...
extension UserInterfaceContext : OpenCloudAppShared.UserInterfaceContextProvider {
