...
extension ClientContext: OpenCloudAppShared.ClientContextProvider {
	public func provideClientContext(for bookmarkUUID: UUID, completion: (Error?, OpenCloudAppShared.ClientContext?) -> Void) {
