...
class ImportPasteboardAction : Action {
	override class var identifier : OCExtensionIdentifier? { return OCExtensionIdentifier("com.opencloud.action.importpasteboard") }
	...
	static let InternalPasteboardCopyKey = "com.opencloud.uti.ocitem.copy"
	static let InternalPasteboardCutKey = "com.opencloud.uti.ocitem.cut"
	static let InternalPasteboardChangedCounterKey = OCKeyValueStoreKey(rawValue: "com.opencloud.internal-pasteboard-changed-counter")
