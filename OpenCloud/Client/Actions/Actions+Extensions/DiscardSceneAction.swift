...
class DiscardSceneAction: Action {
	override class var identifier : OCExtensionIdentifier? { return OCExtensionIdentifier("com.opencloud.action.discardscene") }
	override class var category : ActionCategory? { return .normal }
	override class var name : String { return OCLocalizedString("Close Window", nil) }
