...
{
	return(@{
		OCClassSettingsKeyCustomAppScheme  : @"opencloud",
...
+ (OCClassSettingsMetadataCollection)classSettingsMetadata
{
	return (@{
		...
		OCClassSettingsKeyBuildFlags : @{
			...
			OCClassSettingsMetadataKeyDescription 	: @"A set of space separated flags to customize the build. Must be provided in Branding.plist at build time. For documentation, please see https://github.com/opencloud-eu/ios-app/blob/master/doc/BUILD_CUSTOMIZATION.md.",
		...
		OCClassSettingsKeyCustomAppScheme : @{
			OCClassSettingsMetadataKeyType 		: OCClassSettingsMetadataTypeString,
			OCClassSettingsMetadataKeyDescription 	: @"Name of the URL scheme to use for private links. Must be provided in Branding.plist at build time. For documentation, please see https://github.com/opencloud-eu/ios-app/blob/master/doc/BUILD_CUSTOMIZATION.md.",
			OCClassSettingsMetadataKeyStatus	: OCClassSettingsKeyStatusSupported,
			OCClassSettingsMetadataKeyCategory	: @"Build",
		},
