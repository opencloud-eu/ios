...
! Value
! Description
! `com.opencloud.action.addToSidebar`
! Add to sidebar

! `com.opencloud.action.availableOffline`
! Make available offline

! `com.opencloud.action.collaborate`
! Sharing

! `com.opencloud.action.copy`
! Copy

! `com.opencloud.action.createDocument`
! New document

! `com.opencloud.action.createFolder`
! Create folder

! `com.opencloud.action.createShortcutFile`
! Create shortcut

! `com.opencloud.action.cutpasteboard`
! Cut

! `com.opencloud.action.delete`
! Delete

! `com.opencloud.action.duplicate`
! Duplicate

! `com.opencloud.action.favorite`
! Favorite item

! `com.opencloud.action.importpasteboard`
! Paste

! `com.opencloud.action.markup`
! Markup

! `com.opencloud.action.move`
! Move

! `com.opencloud.action.openShortcutFile`
! Open shortcut

! `com.opencloud.action.openin`
! Open in

! `com.opencloud.action.pdfpage`
! Go to page

! `com.opencloud.action.presentationmode`
! Presentation Mode

! `com.opencloud.action.removeFromSidebar`
! Remove from sidebar

! `com.opencloud.action.rename`
! Rename

! `com.opencloud.action.scan`
! Scan document

! `com.opencloud.action.show-exif`
! Image metadata

! `com.opencloud.action.unfavorite`
! Unfavorite item

! `com.opencloud.action.unshare`
! Unshare

! `com.opencloud.action.upload.camera_media`
! Take photo or video

! `com.opencloud.action.uploadfile`
! Upload file

! `com.opencloud.action.uploadphotos`
...
|app.app-store-link
|string
|`https://itunes.apple.com/app/id6743121005?mt=8`
...
|urlString
|`https://doc.opencloud.eu/ios-app/latest/`
...
branding.url-help
|urlString
|`https://opencloud.eu/docs-guides/`
...
|urlString
|`https://opencloud.eu/privacy-policy/`
...
|urlString
|`https://raw.githubusercontent.com/opencloud/ios-app/master/LICENSE`
...
|urlString
|
|URL of the instance theme.json file, which can contain instance or app specific branding parameter. Setting this to `auto` will construct the URL by adding `themes/opencloud/theme.json` to the respective server's base address.
|advanced `candidate`
...
|string
|`opencloud`
|Name of the URL scheme to use for private links. Must be provided in Branding.plist at build time. For documentation, please see https://github.com/opencloud-eu/ios-app/blob/master/doc/BUILD_CUSTOMIZATION.md.
|supported `candidate`
...
|string
|
|A set of space separated flags to customize the build. Must be provided in Branding.plist at build time. For documentation, please see https://github.com/opencloud-eu/ios-app/blob/master/doc/BUILD_CUSTOMIZATION.md.
|supported `candidate`
...
|http.user-agent
|string
|`OpenCloudApp/{{app.version}} ({{app.part}}/{{app.build}}; {{os.name}}/{{os.version}}; {{device.model}})`
...
! Description
! `lookup-table`
! Locate server via lookup table. Keys can match against the beginning (f.ex. "begins:bob@"), end (f.ex. "ends:@opencloud.eu") or regular expression (f.ex. "regexp:")

! `web-finger`
! Locate server via Webfinger service-instance relation (http://webfinger.opencloud/rel/server-instance) using the entered/provided server URL
...
|string
|`status.php`
|Endpoint to retrieve basic status information and detect an OpenCloud installation.
|advanced `candidate`
...
! `com.opencloud.action.addToSidebar`
! Extension with the identifier com.opencloud.action.addToSidebar.

! `com.opencloud.action.availableOffline`
! Extension with the identifier com.opencloud.action.availableOffline.

! `com.opencloud.action.background_update`
! Extension with the identifier com.opencloud.action.background_update.

! `com.opencloud.action.collaborate`
! Extension with the identifier com.opencloud.action.collaborate.

! `com.opencloud.action.copy`
! Extension with the identifier com.opencloud.action.copy.

! `com.opencloud.action.createDocument`
! Extension with the identifier com.opencloud.action.createDocument.

! `com.opencloud.action.createFolder`
! Extension with the identifier com.opencloud.action.createFolder.

! `com.opencloud.action.createShortcutFile`
! Extension with the identifier com.opencloud.action.createShortcutFile.

! `com.opencloud.action.cutpasteboard`
! Extension with the identifier com.opencloud.action.cutpasteboard.

! `com.opencloud.action.delete`
! Extension with the identifier com.opencloud.action.delete.

! `com.opencloud.action.duplicate`
! Extension with the identifier com.opencloud.action.duplicate.

! `com.opencloud.action.favorite`
! Extension with the identifier com.opencloud.action.favorite.

! `com.opencloud.action.importpasteboard`
! Extension with the identifier com.opencloud.action.importpasteboard.

! `com.opencloud.action.instant_media_upload`
! Extension with the identifier com.opencloud.action.instant_media_upload.

! `com.opencloud.action.markup`
! Extension with the identifier com.opencloud.action.markup.

! `com.opencloud.action.move`
! Extension with the identifier com.opencloud.action.move.

! `com.opencloud.action.openShortcutFile`
! Extension with the identifier com.opencloud.action.openShortcutFile.

! `com.opencloud.action.openin`
! Extension with the identifier com.opencloud.action.openin.

! `com.opencloud.action.pdfpage`
! Extension with the identifier com.opencloud.action.pdfpage.

! `com.opencloud.action.pending_media_upload`
! Extension with the identifier com.opencloud.action.pending_media_upload.

! `com.opencloud.action.presentationmode`
! Extension with the identifier com.opencloud.action.presentationmode.

! `com.opencloud.action.removeFromSidebar`
! Extension with the identifier com.opencloud.action.removeFromSidebar.

! `com.opencloud.action.rename`
! Extension with the identifier com.opencloud.action.rename.

! `com.opencloud.action.scan`
! Extension with the identifier com.opencloud.action.scan.

! `com.opencloud.action.show-exif`
! Extension with the identifier com.opencloud.action.show-exif.

! `com.opencloud.action.unfavorite`
! Extension with the identifier com.opencloud.action.unfavorite.

! `com.opencloud.action.unshare`
! Extension with the identifier com.opencloud.action.unshare.

! `com.opencloud.action.upload.camera_media`
! Extension with the identifier com.opencloud.action.upload.camera_media.

! `com.opencloud.action.uploadfile`
! Extension with the identifier com.opencloud.action.uploadfile.

! `com.opencloud.action.uploadphotos`
! Extension with the identifier com.opencloud.action.uploadphotos.

! `com.opencloud.dark`
! Extension with the identifier com.opencloud.dark.

! `com.opencloud.light`
! Extension with the identifier com.opencloud.light.
...
! `org.opencloud.image`
! Extension with the identifier org.opencloud.image.

! `org.opencloud.media`
! Extension with the identifier org.opencloud.media.

! `org.opencloud.pdfViewer.default`
! Extension with the identifier org.opencloud.pdfViewer.default.

! `org.opencloud.ql_preview`
! Extension with the identifier org.opencloud.ql_preview.

! `org.opencloud.url-shortcut`
! Extension with the identifier org.opencloud.url-shortcut.

! `org.opencloud.webview`
! Extension with the identifier org.opencloud.webview.
...
! Value
! Description
! `com.opencloud.basicauth`
! Basic Auth

! `com.opencloud.oauth2`
! OAuth2

! `com.opencloud.openid-connect`
! OpenID Connect
...
|stringArray
|`[com.opencloud.openid-connect com.opencloud.oauth2 com.opencloud.basicauth]`
