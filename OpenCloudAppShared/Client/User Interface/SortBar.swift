...
public class SortBar: ThemeCSSView {
	...
	public init(frame: CGRect = .zero, sortDescriptor: SortDescriptor) {
		...
		if let sortButton, let selectButton, let changeItemLayoutButton {
			...
			sortButton.focusGroupIdentifier = "com.opencloud.sort-button"
			selectButton.focusGroupIdentifier = "com.opencloud.select-button"
			changeItemLayoutButton.focusGroupIdentifier = "com.opencloud.change-item-layout-button"
