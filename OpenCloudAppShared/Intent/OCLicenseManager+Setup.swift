...
public extension OCLicenseManager {
	func setupLicenseManagement() {
		...
		let shortcutsFeature = OCLicenseFeature(identifier: .shortcuts, name: OCLocalizedString("Shortcuts Actions", nil), description: OCLocalizedString("Use OpenCloud actions in Shortcuts.", nil))
...
extension OCLicenseManager : OpenCloudSDK.OCClassSettingsSupport {
