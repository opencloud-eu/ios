...
public class ThemeResource : NSObject {
	...
	var _resource : Any?
	public func resource(for theme: Theme) -> Any? {
		var result : Any?
	...
	public func asyncResource(for theme: Theme, _ completion: @escaping ((_ resource : Any?) -> Void)) {
		OCSynchronized(self) {
			if _resource != nil {
	...
	public func applyThemeToResource(theme: Theme, collection: ThemeCollection, source: Any?) -> Any? {
		return source
	}
}
