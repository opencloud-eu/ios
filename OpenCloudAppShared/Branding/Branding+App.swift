	...
	public static func initializeBranding() {
		self.registerOCClassSettingsDefaults([
			...
			.themeJSONURL : [
				...
				.description	: "URL of the instance theme.json file, which can contain instance or app specific branding parameter. Setting this to `auto` will construct the URL by adding `themes/opencloud/theme.json` to the respective server's base address.",
				.status		: OCClassSettingsKeyStatus.advanced,
				.category	: "Branding"
			],
...
extension Branding {
	func generateThemeStyle(from theme: [String : Any]) -> ThemeStyle? {
		...
		let identifier = theme["Identifier"] as? String ?? "com.opencloud.branding"
		let name = theme["Name"] as? String ?? "OpenCloud-branding-theme"
